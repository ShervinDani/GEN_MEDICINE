 ...
 * Use the {@link PHomeFragment#newInstance} factory method to
...
public class PHomeFragment extends Fragment {
    ...
    public static PHomeFragment newInstance(String param1, String param2) {
        PHomeFragment fragment = new PHomeFragment();
